...
static char _2Vsccsid[]="@(#)pattern.c	1.1.1.1	(5/8/87)";
...
Restart:
	...
	for(;;){	/* exits in middle */
		...
		for(s=f->str.s+i; s<ends || startp==l; ){
			if ((nl != 0) && (nl[0].node==0)){/* nl will become this list */
