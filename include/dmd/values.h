/* #ident	"@(#)sgs-inc:mc68/values.h	2.4.1.1" */
#ifndef BITSPERBYTE
 ...
 */
#if u3b || M32 || u3b5 || u3b2 || i286 || i386
#if (!i286 && i386)
...
** than the MC68000, it cannot convert MAXFLOAT using the native atof().
** What we do here is define a local constant value whose bits are the
** right ones for the MC68000.
*/

#ifndef	__VALUE_H__
    extern double _MaXdOuBlE_;
    asm("	data 1");
    asm("	even");
    asm("_MaXdOuBlE_:");
    asm("	long 0x7f7fffff");
...
#endif
#define	MAXFLOAT	_MaXdOuBlE_
#define	MAXDOUBLE	_MaXdOuBlE_
/* #define MAXFLOAT	((float)3.40282346638528860e+38) */
/* #define MAXDOUBLE	((double)3.40282346638528860e+38) */
/* MINFLOAT/MINDOUBLE are defined to give the smallest non-denormalized
** value.
*/
#define MINDOUBLE	((double)1.17549435e-38)
...
#if mc68000		/* different because BITS(long) > DSIGNIF */
#define	DMAXPOWTWO	((double)(1L << DSIGNIF - 1))
#else
